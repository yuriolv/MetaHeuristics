...
class GA:
    ...
    def generate_chromosome(self, individual):
        for j in range(4):
                if(j == 0):
                    ...
                    individual.chromosome.append(rd.randint(10, 70))
    ...
    def chromosome_encoding(self, individual):
        ...
        if(individual.chromosome[0] == 1):
            ...
            coded.append('entropy')
        elif(individual.chromosome[0] == 3):
            coded.append('log_loss')

        coded.extend(individual.chromosome[1:])
    ...
    def evaluate_individual(self, individual):
        ...
        model = DecisionTreeClassifier(criterion=coded_chromosome[0], max_depth=coded_chromosome[1],
        min_samples_split=coded_chromosome[2],max_features=coded_chromosome[3])
